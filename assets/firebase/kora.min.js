       ...
       <div class="card card-s3">
          ...
          <div class="card-body px-0 pb-0">
             ...
             <div class="card-price-wrap d-flex align-items-center justify-content-between">
                <div class="me-5 me-sm-2" style="display: ${product.displayHarga};">
                ...
                <ul class="btns-group d-flex">
                    ...
                    <a href="${product.BuyLink}" class="btn btn-sm bg-dark-dim" style="display: ${product.displayBuy};">Buy Now</a>
                    </li>
                </ul>
