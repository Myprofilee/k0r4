       ...
       <div class="card card-full card-s3">
          ...
          <div class="card-body px-0 pb-0">
             ...
             <div class="card-price-wrap d-flex align-items-center justify-content-between">
                ...
                <a href="${product.preview}" class="btn btn-sm bg-dark-dim" style="display: ${product.displayPreview};"><i class="ri-eye-line"></i></a>
                <a href="${product.link}" class="btn btn-sm bg-dark-dim" style="display: ${product.displayBuy};">Buy Now</a>
             </div>
          </div>
          <!-- end card-body -->
       </div>
