...
db.collection("/kora/product/explore/").onSnapshot((snapshot) => {
             ...
             <div class="card-price-wrap d-flex align-items-center justify-content-between">
                ...
                <ul class="btns-group d-flex">
                    <li class="flex-grow-2">
                        <a href="${product.PreviewLink}" class="btn btn-sm bg-dark-dim" style="display: ${product.displayPreview};"><i class="ri-eye-line"></i></a>
                        <a href="${product.BuyLink}" class="btn btn-sm bg-dark-dim" style="display: ${product.displayBuy};">Get Now</a>
                    </li>
                </ul>
